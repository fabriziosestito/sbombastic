...
func NewImageStore(
	...
	natsBroadcaster := newNatsBroadcaster(nc, imageResourcePluralName, watchBroadcaster, logger)
	...
	registryStore := &registry.Store{
		...
		DefaultQualifiedResource:  v1alpha1.Resource(imageResourcePluralName),
		SingularQualifiedResource: v1alpha1.Resource(imageResourceSingularName),
