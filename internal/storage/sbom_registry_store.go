...
func NewSBOMStore(
	...
	natsBroadcaster := newNatsBroadcaster(nc, sbomResourcePluralName, watchBroadcaster, logger)
	...
	registryStore := &registry.Store{
		...
		DefaultQualifiedResource:  v1alpha1.Resource(sbomResourcePluralName),
		SingularQualifiedResource: v1alpha1.Resource(sbomResourceSingularName),
